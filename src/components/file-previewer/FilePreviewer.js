...
// import { CustomBoxImageText } from "../form-fields/FileInputField"; // 6am default code
import { CustomBoxImageText } from "./FilePreviewer.style"; // new code to solve customboximagetext error
