...
const PercelDelivery = ({ configData }) => {
  ...
  const addAddressFormik = useFormik({
    initialValues: {
      ...
      weight: parcelInfo?.weight ? parcelInfo?.weight : "",
    },
  ...
  const senderWeightHandler = (value) => {
    addAddressFormik.setFieldValue("weight", value);
  };
        ...
        <Grid container spacing={4}>
          <Grid item xs={12} sm={12} md={4}>
            <SenderInfoForm
              ...
              senderWeightHandler={senderWeightHandler}
              coords={coords}
